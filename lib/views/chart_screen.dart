...
class _chartState extends State<chart_screen> {
  ...
  Widget build(BuildContext context) {
    final chartprovider = Provider.of<DbProvider>(context, listen: false);
    List expensedata = chartprovider.expenceList;
          ...
          PieChartData(
            sections: List.generate(
              ...
              (index) {
                ...
                double totalCost = value.calculateTotalCost(expense);
